...
const CACHE = 'riwon-math-v26-family-star';
const ASSETS = ['./', './index.html', './manifest.webmanifest', './icon.svg', './icon-180.png',
  './grades/g1.js', './grades/g3-time.js', './daily.js', './expr.js', './coach.js', './family.js', './work.js', './bridge.js', './ui.js', './family-look.css', './family-look.js', './reward-goals.js', './school-plan.js', './learning-loop.js', './fan-theme.js', './assets/rora-manila-2026.jpg', './assets/wonyoung-2025.png'];
